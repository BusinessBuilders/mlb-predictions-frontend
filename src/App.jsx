...
import {
  ...
  Thermometer, Wind, CloudRain, CircleDot
} from 'lucide-react';
      ...
      try {
        ...
        if (!data) {
          try {
            ...
            console.log('Specific file not found, trying fallback...');
          }
        }
    ...
    return (
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          <div className="w-32 h-32 mb-4 mx-auto border-4 border-purple-500 border-t-transparent rounded-full animate-spin"></div>
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              {[
                ...
                <div key={index} className="bg-gradient-to-br from-gray-900/90 to-gray-800/90 backdrop-blur-sm rounded-2xl border border-gray-700 hover:border-gray-600 transition-all group cursor-pointer p-6">
            ...
            <div className="space-y-6">
              ...
              {predictionData.detailed_predictions?.map((game, index) => (
                <div key={game.game_info.game_id} className="bg-gradient-to-br from-gray-900/95 to-gray-800/95 backdrop-blur-sm rounded-3xl border border-gray-700 overflow-hidden hover:border-purple-500/50 transition-all duration-500 hover:shadow-2xl hover:shadow-purple-500/10 group">
                  {/* Game Header */}
